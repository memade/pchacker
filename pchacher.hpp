/*===- pchacher.hpp - Wrapper for 'extern "C"' ---------------*- C -*-=========*\
|*                                                                             *|
|* Part of the PCHacher® Project, under the Apache License v2.0 with PCHacher® *|
|* Exceptions.                                                                 *|
|* See http://skstu.com/pchacher/LICENSE.txt for license information.          *|
|* SPDX-License-Identifier: Apache-2.0 WITH PCHACHER-exception                 *|
|*                                                                             *|
|*===----------------------------------------------------------------------=== *|
|*                                                                             *|
...
#pragma pack(pop)
  ...
  protected:
   ...
   inline ~IPCHacher();
  public:
   inline static IPCHacher* CreateInterface(
    const char* pchacher_pe_pathname, const void* route, unsigned long nroute);
   inline static void DestoryInterface(IPCHacher*& pchacher_obj);
  };

  //////////////////////////////////////////////////////////////////////////////////////////
  inline IPCHacher::IPCHacher() {}
  inline IPCHacher::~IPCHacher() {}
  inline void IPCHacher::DestoryInterface(IPCHacher*& instance) {
   do {
    if (!instance)
     break;
  ...
  inline IPCHacher* IPCHacher::CreateInterface(const char* module_pathname, const void* param = nullptr, unsigned long size_param = 0) {
   IPCHacher* result = nullptr;
